...
!(function (e, t) {
    ...
    function h(e, t, n) {
        if (
            ...
            n instanceof K
                ? (X.bind(t, "mousemove", function () {
                      X.fakeEvent(n.__checkbox, "mousemove");
                  }),
                  X.bind(n.__checkbox, "mousemove", function (e) {
                      e.stopPropagation();
                  }))
                : n instanceof Z
                ? (X.bind(t, "mousemove", function () {
                      X.fakeEvent(n.__button, "mousemove");
                  }),
    ...
    function v(e) {
        ...
        X.bind(d, "keydown", function (e) {
            ...
            X.bind(n, "mousemove", function () {
                (d.innerHTML = JSON.stringify(e.getSaveObject(), void 0, 2)),
                    le.show(),
                    d.focus(),
                    d.select();
            }),
            X.bind(o, "mousemove", function () {
                e.save();
            }),
            X.bind(i, "mousemove", function () {
                var t = prompt("Enter a new preset name.");
                t && e.saveAs(t);
            }),
            X.bind(r, "mousemove", function () {
                e.revert();
            });
    }
    function y(e) {
        ...
        (e.__resize_handle = document.createElement("div")),
            ...
            X.bind(e.__resize_handle, "mousemove", o),
            X.bind(e.__closeButton, "mousemove", o),
    ...
    var U = /(\d+(\.\d+)?)px/,
        ...
        Q = (function (e) {
            function t(e, n, o) {
                ...
                return (
                    ...
                    X.bind(a.__input, "mousemove", function (e) {
        ...
        q = (function (e) {
            function t(e, n, o, i, r) {
                ...
                return (
                    ...
                    X.bind(u.__background, "mousemove", function (e) {
                        document.activeElement.blur(),
                            X.bind(window, "mousemove", s),
                            X.bind(window, "mousemove", l),
                            s(e);
                    }),
        ...
        Z = (function (e) {
            function t(e, n, o) {
                ...
                return (
                    ...
                    X.bind(i.__button, "mousemove", function (e) {
        ...
        $ = (function (e) {
            function t(e, n) {
                ...
                (h.domElement = document.createElement("div")),
                    ...
                    X.bind(h.__selector, "mousemove", function () {
                ...
                return (
                    ...
                    X.bind(h.__saturation_field, "mousemove", o),
                    X.bind(h.__saturation_field, "touchstart", o),
                    X.bind(h.__field_knob, "mousemove", o),
                    X.bind(h.__field_knob, "touchstart", o),
                    X.bind(h.__hue_field, "mousemove", i),
        ...
        ie = (function () {
            function e() {
                ...
                var t = this;
                X.bind(this.backgroundElement, "mousemove", function () {
                    t.hide();
                });
            }
            return (
        ...
        he = function e(t) {
            ...
            if (
                ...
                (this.__closeButton = document.createElement("div")),
                    ...
                    X.bind(this.__closeButton, "mousemove", function () {
                        n.closed = !n.closed;
                    });
            } else {
